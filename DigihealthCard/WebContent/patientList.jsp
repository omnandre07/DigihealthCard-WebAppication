...
<head>
  <meta charset="UTF-8">
  <title>Patient List | DigiHealthCard</title>
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css" rel="stylesheet">
  <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet">

  <style>
    /* Same styles as adminDashboard.jsp */
    :root {
      --primary: #2563eb;
      --primary-dark: #1e40af;
...
<%
  ...
  try {
    ...
    PreparedStatement ps = con.prepareStatement("SELECT * FROM patient ORDER BY id DESC");
    rs = ps.executeQuery();
  } catch (Exception e) {
    out.println("Error: " + e);
  }
...
<div class="sidebar">
  ...
  <a href="#" class="active"><i class="fas fa-users"></i><span>Patient List</span></a>
