...
<head>
  ...
  <title>Doctor Login - DigiHealthCard</title>
...
<body>
  <div class="login-container">
    <div class="welcome-panel">
      ...
      <p>Securely access patient information, manage health records, and collaborate with the DigiHealthCard system.</p>
    </div>

    <div class="login-panel">
      <div class="login-header">
        <h2>Doctor Login</h2>
        <p>Sign in to access your DigiHealthCard dashboard</p>
      </div>
