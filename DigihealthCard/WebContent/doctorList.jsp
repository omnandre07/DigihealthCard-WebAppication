...
<head>
  <meta charset="UTF-8">
  <title>Doctor List | DigiHealthCard</title>
...
<div class="sidebar">
  ...
  <a href="#" class="active"><i class="fas fa-user-md"></i> <span>Doctor List</span></a>
...
<div class="main-content">
  ...
  <div class="table-section">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
      <h3>All Doctors</h3>
      <a href="addDoctor.jsp" style="background-color: var(--primary); color: white; padding: 0.5rem 1rem; border-radius: 6px; text-decoration: none; font-weight: 500;">
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a href="editDoctor.jsp?id=<%= rs.getInt("id") %>" class="action-btn edit-btn">
              <i class="fas fa-edit"></i> Edit
            </a>
            <a href="deleteDoctor.jsp?id=<%= rs.getInt("id") %>" class="action-btn delete-btn" onclick="return confirm('Are you sure you want to delete this doctor?');">
