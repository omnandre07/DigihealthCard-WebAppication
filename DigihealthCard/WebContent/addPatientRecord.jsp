...
<%
    ...
    try {
        ...
        PreparedStatement pst = con.prepareStatement("SELECT id, name FROM doctor WHERE email=?");
        ...
        out.println("Error fetching doctor ID: " + e.getMessage());
    }
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        String patientContactid = request.getParameter("patientContactid");
        ...
        try {
            ...
            PreparedStatement pst = con.prepareStatement(
                "INSERT INTO records (patientContactid, doctorContactid, recordType, description, date) VALUES (?, ?, ?, ?, ?)"
            );
            pst.setInt(1, Integer.parseInt(patientContactid));
            pst.setInt(2, doctorId);
            pst.setString(3, recordType);
...
<head>
  <meta charset="UTF-8">
  <title>Add Patient Record | DigiHealthCard</title>
...
<div class="sidebar">
  ...
  <a href="addPatientRecord.jsp" class="active"><i class="fas fa-user-plus"></i> <span>Add Records</span></a>
...
<div class="main-content">
  ...
  <div class="form-section">
    ...
    <h3><i class="fas fa-file-medical"></i> Patient Health Record</h3>
    
    <form method="post">
      <div class="form-group">
        <label for="patientContactid">Patient Contact ID</label>
        <input type="number" id="patientContactid" name="patientContactid" required>
      </div>

      <div class="form-group">
        <label for="recordType">Record Type</label>
        <input type="text" id="recordType" name="recordType" required>
      </div>
