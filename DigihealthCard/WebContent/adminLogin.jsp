...
<head>
  ...
  <title>Admin Login - DigiHealthCard</title>
...
<body>
  <div class="login-container">
    <div class="welcome-panel">
      <h1>Welcome Admin</h1>
      <p>Manage doctors, patients, and digital health records securely with full control through DigiHealthCard's admin portal.</p>
    </div>

    <div class="login-panel">
      <div class="login-header">
        <h2>Admin Login</h2>
        <p>Sign in to manage the DigiHealthCard system</p>
      </div>
      ...
      <div class="login-footer">
        ...
        <div>&copy; <span id="current-year"></span> DigiHealthCard. All rights reserved.</div>
      </div>
