...
<%
    ...
    if (doctorEmail != null && newEmail != null && newContact != null) {
        try {
            Connection con = Dbconnection.connect();
            PreparedStatement pst = con.prepareStatement("UPDATE doctor SET email=?, contact=? WHERE email=?");
            ...
            if (rows > 0) {
                session.setAttribute("doctor", newEmail); // Update session email
                message = "Your email and contact have been updated successfully!";
            } else {
