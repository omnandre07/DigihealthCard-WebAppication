...
<head>
  <meta charset="UTF-8">
  <title>Patient Dashboard | DigiHealthCard</title>
  <meta name="viewport" content="width=device-width, initial-sXcale=1.0">
...
<div class="sidebar">
  ...
  <a href="#" class="active"><i class="fas fa-user"></i> <span>My Profile</span></a>
...
<div class="main-content">
  ...
  <div class="profile-section">
    ...
    <button class="action-btn btn-primary" onclick="location.href='editProfile.jsp'">
