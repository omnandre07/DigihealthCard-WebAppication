...
<head>
  <meta charset="UTF-8">
  <title>Admin Dashboard | DigiHealthCard</title>
...
<%
  ...
  try {
    ...
    PreparedStatement ps1 = con.prepareStatement("SELECT COUNT(*) FROM doctor");
    ResultSet rs1 = ps1.executeQuery();
    if (rs1.next()) totalDoctors = rs1.getInt(1);

    PreparedStatement ps2 = con.prepareStatement("SELECT COUNT(*) FROM patient");
    ResultSet rs2 = ps2.executeQuery();
    if (rs2.next()) totalPatients = rs2.getInt(1);

    PreparedStatement ps3 = con.prepareStatement("SELECT COUNT(*) FROM records");
    ResultSet rs3 = ps3.executeQuery();
    if (rs3.next()) totalRecords = rs3.getInt(1);

    PreparedStatement ps4 = con.prepareStatement("SELECT * FROM records ORDER BY date DESC LIMIT 5");
    rs = ps4.executeQuery();
...
<div class="sidebar">
  ...
  <a href="#" class="active"><i class="fas fa-chart-line"></i> <span>Dashboard</span></a>
